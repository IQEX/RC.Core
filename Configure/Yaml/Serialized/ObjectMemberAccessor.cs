...
namespace Rc.Framework.Yaml.Serialization
{
    /// <summary>
    /// 
    /// object ni dainyū sa reta kurasu ya kōzōtai no menbā ni, rifurekushon o
    /// Kai shite kantan ni akusesu dekiru yō ni shita kurasu
    /// 
    /// Akusesu hōhō o kyasshu surunode, kurikaeshi shiyō suru baai ni kōsoku-ka ga
    /// kitai dekiru
    /// </summary>
    internal class ObjectMemberAccessor
    {
        ...
        /// <summary>
        /// 
        /// Shitei shita kata e no akusesu hōhō o arawasu insutansu o kaesu
        /// Kyasshu ni sonzai sureba sore o kaesu
        /// Kyasshu ni sonzai shinakereba atarashiku tsukutte kaesu
        /// Tsukutta mono wa kyasshu sa reru
        /// </summary>
        /// <param name="type">Kurasu matawa kōzōtai o arawasu kata jōhō</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Menba e no yomikaki o okonau koto ga dekiru
        /// </summary>
        /// <param name="obj">Obujekuto</param>
        /// <param name="name">Menba no namae</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Menba-mei to Accessor no pea o junkai suru
        /// </summary>
        /// <returns></returns>
