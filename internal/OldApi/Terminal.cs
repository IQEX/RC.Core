...
namespace Rc.Framework
{
    ...
    public static partial class Terminal
    {
        ...
        /// </summary>
        [Obsolete("[Old 3.5 api], Use Windows.Title")]
        ...
        /// </summary>
        /// <returns></returns>
        [Obsolete("[Old 3.5 api], Use Stream.ReadLine()")]
        ...
        [Obsolete("[Old 3.5 api], Use Cursor.pos")]
        ...
        [Obsolete("[Old 3.5 api], Use Windows.SetBuffer(buffer)")]
        ...
        [Obsolete("[Old 3.5 api], Use Windows.SetTransform(transf)")]
        ...
        [Obsolete("[Old 3.5 api], Use Windows.transform")]
    ...
    /// <summary>
    /// Enum of version API RCL Terminal
    /// </summary>
    public enum VTerminalAPI
    {
        /// <summary>
        /// Old Version Terminal RCL
        /// primary:
        ///     "+g4\0TEXT+g0\0" || "+g4 TEXT+g0 "
        ///         /\       /\         /\      /\
        ///         ||       ||         ||      ||
        ///         \         DELETE CHAR        /   
        ///          *==========================*
        ...
        v4_5,
        /// <summary>
        /// New Version Terminal RCL
        ///     primary:
        ///     "+g4TEXT+g0 +g2or+g0 TEXT"
        ///     to print, 'TEXT' - green color, 'or' - Cyan color ('TEXT or TEXT')
        /// </summary>
        v8_1
    }
}
