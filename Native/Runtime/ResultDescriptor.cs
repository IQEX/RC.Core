...
namespace Rc.Framework.Native.Runtime
{
    ...
    public sealed class ResultDescriptor
    {
        ...
        /// <param name="module">The module (ex: Direct2D1).</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ResultDescriptor"/> to <see cref="Result"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ResultDescriptor"/> to <see cref="System.Int32"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ResultDescriptor"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <returns>The result of the conversion.</returns>
