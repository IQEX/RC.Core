...
namespace Rc.Framework.Native.Runtime
{
    ...
    public class ComObject : CppObject, IUnknown
    {
        ...
        /// <exception cref="COMException">If this object doesn't support the interface</exception>
        ...
        {
            IntPtr parentPtr;
            this.QueryInterface(NativeMethods.GetGuidFromType(typeof(T)), out parentPtr);
        ...
        public static T QueryInterfaceOrNull<T>(IntPtr comPointer) where T : ComObject
        {
            ...
            var guid = NativeMethods.GetGuidFromType(typeof(T));
            IntPtr pointerT;
        ...
        {
            return FromPointer<T>(QueryInterfaceOrNull(NativeMethods.GetGuidFromType(typeof(T))));
        }
        ...
        {
            IntPtr parentPtr;
            fromObject.QueryInterface(NativeMethods.GetGuidFromType(this.GetType()), out parentPtr);
