...
bool isInCompatibilityMode = false;
        ...
        public static void WriteMixFormatted(string format, Color defaultColor, Formatter[] args, Formatter[] args2)
        {
            WriteInMixColorFormatted(WRITE_TRAILER, format, args, args2, defaultColor);
        }
