...
namespace RC.Framework.Collections.Generic
{
    ...
    public class Matrix<T> : IMatrix<T>
    {
        ...
        T current;
        int curIndex = -1;
        private static readonly SizeMatrix DefaultSize1 = new SizeMatrix(X: 5, Y: 5);
        ...
        bool IEnumerator.MoveNext()
        {
            ...
            {
                var x = curIndex / Size.Y;
                var y = curIndex - Size.Y * x;
                current = matrix[x, y];
            }
            return true;
        }
    ...
    /// Размер матрицы.
    /// </summary>
    [Serializable] public class SizeMatrix
    {
        /// <summary>
        /// Количество строк
        /// </summary>
        ...
        /// Нулевая матрица
        /// </summary>
        public static SizeMatrix Zero { get { return new SizeMatrix(X: 0, Y: 0); } }
        /// <summary>
