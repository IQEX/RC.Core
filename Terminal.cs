...
namespace RC.Framework
{
    ...
    public static class Terminal
    {
        ...
        public static void WriteLine(string s, bool isTrace, [CallerMemberName] string member = "?", [CallerLineNumber] int line = 0, bool isUseHeader = false)
        {
            if (!isTrace)
            {
                WriteLine(s);
        ...
        public static void WriteLine(Exception ex, [CallerMemberName] string member = "?", [CallerLineNumber] int line = 0, [CallerFilePath] string file = "", bool isUseHeader = false)
        {
