...
namespace RC.Framework.FileSystem.Xva
{
    ...
    using System.Text;
    using DiskRecord = RC.Framework.FileSystem.Tuple<string, RC.Framework.FileSystem.SparseStream, RC.Framework.FileSystem.Ownership>;
